<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GestionSubarea.aspx.cs" Inherits="QUIEN_LO_HACE.GestionSubarea" %>
    ...
    <div class="container">
        <div class="divPanel page-content">
            <div class="breadcrumbs">
                <a href="PanelControlAdmon.aspx">Panel de Control</a> &nbsp;/&nbsp; <span>Administrar Subáreas</span>
            </div> 
        </div>
        ...
        <div class="row-fluid">
            ...
            <form id="form1" runat="server">
                ...
                <div class="table-responsive">
                    <asp:GridView ID="dgSubarea" runat="server" style="width:60%" CssClass="table-bordered" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="Id" OnPageIndexChanging="dgRol_PageIndexChanging" OnSelectedIndexChanging="dgRol_SelectedIndexChanging" PageSize="5">
                        <Columns>
                            <asp:BoundField DataField="Id" HeaderText="ID" />
                            <asp:BoundField DataField="Subarea" HeaderText="SUBÁREA" />
