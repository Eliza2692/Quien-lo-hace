<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GestionArea.aspx.cs" Inherits="QUIEN_LO_HACE.GestionArea" %>
        ...
        function showimagepreview(input) {
            if (input.files && input.files[0]) {
                ...
                filerdr.onload = function (e) {
                    $('#logoArea').attr('src', e.target.result);
                }
...
<body>
    ...
    <div class="container">
       ...
       <!--ENCABEZADO--><!-- Barra de Menu --><div class="divPanel topArea notop nobottom">
            <div class="row-fluid">
                <div class="span12">
    ...
    <div class="container">
        <div class="divPanel page-content">
            <div class="breadcrumbs">
                <a href="PanelControlAdmon.aspx">Panel de Control</a> &nbsp;/&nbsp; <span>Administrar Áreas</span>
            </div> 
        </div>
            ...
            <form id="form1" runat="server">
                ...
                <div class="span4 sidebar">
                    <div class="sidebox" style="text-align:center">
                        <img id="logoArea" src="http://placehold.it/140x140" class="img-polaroid" alt="" />
                        <br/>
                ...
                <div class="table-responsive">
                    <asp:GridView ID="dgArea" runat="server" style="width:60%" CssClass="table-bordered" AutoGenerateColumns="False" DataKeyNames="Id" OnPageIndexChanging="dgArea_PageIndexChanging" OnSelectedIndexChanging="dgArea_SelectedIndexChanging" PageSize="5">
                        <Columns>
