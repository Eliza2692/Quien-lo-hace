<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PanelControlCliente.aspx.cs" Inherits="QUIEN_LO_HACE.PanelControlCliente" %>
                    ...
                    <div id="gridArea">
                        <ul id="tiles">
                            ...
                            <li>
                                ...
                                <h4><a href="#">Historial de Tareas</a></h4>                            
                            </li>
                            <li>
                                <a href="#"><img src="img/trabajo.jpg" alt="Sticky" title="Sticky"/></a>
                                <h4><a href="#">Sé un experto</a></h4>                            
                            </li>
                        </ul>
                    </div>
                </div>
