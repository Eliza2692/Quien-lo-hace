<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditarTarea.aspx.cs" Inherits="QUIEN_LO_HACE.EditarTarea" %>
    ...
    <div class="container">
        <div class="divPanel page-content">
            <div class="breadcrumbs">
                <a href="PanelControlCliente.aspx">Panel de Control</a> &nbsp;/&nbsp;<a href="TareasPendientes.aspx">Tareas Pendientes</a> &nbsp;/&nbsp;  <span>Editar Tarea</span>
            </div> 
        </div>
    ...
    <!--Descripción quien lo hace-->
                ...
                <div class="span12">
                     <div class="span3">
                        ...
                        <div class="input-append">
                            <asp:FileUpload ID="fileImgArea" runat="server" onchange="showimagepreview(this)" accept=".png,.jpg,.jpeg,.gif"/>  
                        </div>   
                    </div>
                    <div class="span3">
                        ...
                        <br/>
                        <div class="input-append">
                            <asp:FileUpload ID="FileUpload1" runat="server" onchange="showimagepreview(this)" accept=".png,.jpg,.jpeg,.gif"/>  
                        </div>   
                    </div>  
                    <div class="span3">
                        ...
                        <br/>
                        <div class="input-append">
                            <asp:FileUpload ID="FileUpload2" runat="server" onchange="showimagepreview(this)" accept=".png,.jpg,.jpeg,.gif"/>  
                        </div>   
                    </div>  
                    <div class="span3">
                        ...
                        <br/>
                        <div class="input-append">
                            <asp:FileUpload ID="FileUpload3" runat="server" onchange="showimagepreview(this)" accept=".png,.jpg,.jpeg,.gif"/>  
                        </div>   
                    </div>                
                </div>
   	...
   	<!--Registro-->
        <div class="span4" id="divMain">
            ...
            <h4>Experto Asignado</h4>
            <!--Experto-->
                <div class="span12">
                    <label>Experto: </label>
                    <asp:TextBox ID="txtExperto" runat="server" class="input-xlarge"></asp:TextBox><br/>
                     <asp:Button ID="btnCambiarExperto" runat="server" Text="Cambiar Experto" CssClass="btn btn-success"  />
                </div>
            <br /><br /> 
            <h4>Estado Tarea</h4>
            <!--Estado Tarea-->
                <div class="span12">
                    <label>Estado: </label>
                    <asp:DropDownList ID="DropDownList3" runat="server" CssClass="form-control"></asp:DropDownList><br/>
                     <asp:Button ID="btnCambiarEstado" runat="server" Text="Cambiar Estado" CssClass="btn btn-success"  />
                </div>
            <br /><br /> 
            <!--Estado Tarea-->
                <div class="span12">
                    ...
                    <label>Estado: </label>
                    <asp:TextBox ID="TextBox1" runat="server" class="input-xlarge"></asp:TextBox><br/>
                     <asp:Button ID="btnCalificarTarea" runat="server" Text="Calificar Tarea" CssClass="btn btn-success"  />
                </div>      
