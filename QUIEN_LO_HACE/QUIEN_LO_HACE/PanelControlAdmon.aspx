<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PanelControlAdmon.aspx.cs" Inherits="QUIEN_LO_HACE.WebForm1" %>
        ...
        <div class="row-fluid">
                <div class="span12">
                    ...
                    <div id="gridArea">
                        <ul id="tiles">
                            <li>
                                <a href="GestionEstado.aspx" title="Sticky" rel="prettyPhoto[gallery1]"><img src="styles/thumbs/sticky_350.jpg" alt="Sticky" title="Sticky"/></a>
                                <h4><a href="GestionEstadoUsuario.aspx">Administrar Estados (Usuario)</a></h4>                            
                            </li>
                            <li>
                                <a href="GestionRol.aspx" title="Sticky" rel="prettyPhoto[gallery1]"><img src="styles/thumbs/sticky_350.jpg" alt="Sticky" title="Sticky"/></a>
                                <h4><a href="GestionRol.aspx">Administrar Roles</a></h4>                            
                            </li> 
                            <li>
                                <a href="GestionArea.aspx" title="Sticky" rel="prettyPhoto[gallery1]"><img src="styles/thumbs/sticky_350.jpg" alt="Sticky" title="Sticky"/></a>
                                <h4><a href="GestionArea.aspx">Administrar Áreas</a></h4>                            
                            </li> 
                            <li>
                                <a href="GestionSubarea.aspx" title="Sticky" rel="prettyPhoto[gallery1]"><img src="styles/thumbs/sticky_350.jpg" alt="Sticky" title="Sticky"/></a>
                                <h4><a href="GestionSubarea.aspx">Administrar Subáreas</a></h4>                            
                            </li> 
                        </ul>
                    </div>
                </div>
